...
{
    if (!_bankListTabel) {
        _bankListTabel = [[UITableView alloc] initWithFrame:CGRectMake(0.0f, 64.0f, ScreenWidth, ScreenHeight-64.0f) style:UITableViewStyleGrouped];
...
//            if (*stop==NO) {
//                if ([obj[@"bankName"] isEqualToString:_bankId]) {
